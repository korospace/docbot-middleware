...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('m_assanahs', function (Blueprint $table) {
            $table->bigInteger('nkdassanah',false)->primary();
            $table->string('nnmassanah')->unique();
    ...
    {
        Schema::dropIfExists('m_assanahs');
    }
};
